...
type Config struct {
	...
	TransposeOverflow  bool               `json:"transposeOverflow" yaml:"transposeOverflow" description:"When high cardinality is detected, transpose parent entity instead of keeping it as JSON."`
